...
```{r function-cohen_sample_size}
#' Cohen’s kappa Sample Size
#' Under this design, each of the r participating raters must rate all n participating subjects.
#' The default values are for having two raters and two categories.
#' @param alpha significance level
#' @param E two sided error margin
#' @param a 
#' @param b 
#'
#' @return
...
#'
#' @examples
cohen_sample_size <- function(alpha = 0.05, E = 0.1, a = 4.0081, b = -4.0532 ){
  alpha_val <- 1-alpha
  qq <- qnorm(alpha_val)
  nom = qq^2/E^2-b
  n = nom/a
